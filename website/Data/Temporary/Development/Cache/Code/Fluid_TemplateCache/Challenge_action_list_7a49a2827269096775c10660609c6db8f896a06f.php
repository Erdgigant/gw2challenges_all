<?php 
class Challenge_action_list_7a49a2827269096775c10660609c6db8f896a06f extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output16 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('challenge.id', $array17), ENT_QUOTES);

$output16 .= ' - ';
$array18 = array (
);
$output16 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('challenge.name', $array18), ENT_QUOTES);
...
$array15 = array (
);$arguments13['each'] = $renderingContext->getVariableProvider()->getByPath('challenges', $array15);
$arguments13['as'] = 'challenge';
